<template>
    <div>
        ...
        <template v-else>
            <grid-layout :layout.sync="layout" :col-num="60" :row-height="1" :is-draggable="design"
                :is-resizable="design" :is-mirrored="false" :vertical-compact="true" :margin="[20, 20]"
                :use-css-transforms="true" :autoSize="true">
                <grid-item v-for="(item, index) in layout" :x="item.x" :y="item.y" :w="item.w"
